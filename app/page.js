...
export default function Home() {
    ...
    return (
        <div className="pt-60px max-w-[904px] m-auto">
            ...
            <p className="text-center text-12 text-gray-500 m-auto max-w-[460px]">
                ...
                test, debug and review webhook events; just like you will with
                Convoy{" "}
            </p>
                        ...
                        >
                            ...
                            <img
                                ...
                                className={`ml-28px transition-all duration-300 ease-in-out ${
                                    showSubscriptionDropdown ? "rotate-180" : ""
                                }`}
                            />
                        </button>
                    </div>
                ...
                {showSubscriptionDropdown && (
                    <div className="transition-all ease-in-out duration-300 absolute top-[110%] max-w-[560px] w-full bg-white-100 border border-primary-25 rounded-4px shadow-default z-10 h-fit max-h-[100px]">
                        {subscriptions.map((item) => (
                            ...
                            >
                                <div className="relative w-fit h-fit border-0">
                                    <input
                                        id={item}
                                        type="radio"
                                        value={item}
                                        checked={activeSubscription === item}
                                        onChange={() => {
                                    ...
                                    >
                                        <div
                                            className={`border-none rounded-4px p-4px ${
                                                activeSubscription === item
                                                    ? "bg-primary-25"
                                                    : "bg-white-100"
                                            }`}
                                        >
                                            <div className="border border-primary-400 rounded-4px h-12px w-12px transition-all duration-200 ">
                                                {activeSubscription ===
                                                    item && (
                                                    <img
            ...
            {showEvents && (
                <div className="flex mb-200px mt-40px">
                    <div className="min-w-[470px] mr-16px w-full  overflow-hidden rounded-8px bg-white-100 border border-primary-25">
                        <div className="min-h-[70vh]">
                            <table className="w-full border-b border-gray-200">
                                <tbody>
                                    <tr className="border-b border-gray-200 py-10px">
                                        <td className="text-12 text-gray-400 py-10px px-10px">
                                            17 Jan, 2022
                                        </td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>
                                            <div className="flex items-center justify-center ml-10px px-12px py-2px text-12 font-medium w-fit rounded-24px bg-success-50 text-success-400 my-10px">
                                                Success
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td className="text-12 text-gray-500">
                                            10:45:11Am
                                        </td>
                                        <td>
                                            <button className="border-none bg-transparent">
                    ...
                    <div className="max-w-[400px] w-full min-h-[70vh] rounded-8px bg-white-100 border border-primary-25">
